          ...
          <ListGroup variant="flush">
            <ListGroup.Item>
              ...
              {order.isDelivered ? (
                ...
                <Message variant="danger">
                  Ainda não entregue {order.deliveredAt}
                </Message>
              )}
            </ListGroup.Item>
            ...
            <ListGroup.Item>
              ...
              {order.isPaid ? (
                ...
                <Message variant="danger">Not paid yet. {order.paidAt}</Message>
              )}
            </ListGroup.Item>
          ...
          <Card>
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <Row>
                  <Col>Items</Col>
                  <Col>R$ {showDecimals(order.itemsPrice)}</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
                  <Col>Shipping</Col>
                  <Col>R$ {showDecimals(order.shippingPrice)}</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
                  <Col>Tax</Col>
                  <Col>R$ {showDecimals(order.taxPrice)}</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
                  <Col>Total</Col>
                  <Col>R$ {showDecimals(order.totalPrice)}</Col>
                </Row>
              </ListGroup.Item>
